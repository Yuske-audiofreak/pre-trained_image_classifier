...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_match'] = 0.0          # percentage of correct matches
    results_stats_dic['pct_correct_dogs'] = 0.0   # percentage of correctly classified dogs
    results_stats_dic['pct_correct_breed'] = 0.0  # percentage of correctly classified dog breeds
    results_stats_dic['pct_correct_notdogs'] = 0.0    # percentage of correctly classified NON-dogs

    # number of images
    results_stats_dic['n_images'] = len(results_dic)

    # Check command for Image number
    # print("")
