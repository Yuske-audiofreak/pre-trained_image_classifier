...
def print_results(results_dic, results_stats_dic, model,
    ...
    print("Percentage of correctly classified notdogs", results_stats_dic['pct_correct_notdogs'], "  ")
    print("Perventage of correctly classified matches", results_stats_dic['pct_match'], " ")


    # Misclassified Dogs
    # If the user wants to print misclassifications print_incorrect_dogs = True
        ...
        if results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']:
            ...
            for key in results_dic:
                if sum(results_dic[key][3:]) == 1:
                    print("Misclassified Dogs is =", key, " ")
